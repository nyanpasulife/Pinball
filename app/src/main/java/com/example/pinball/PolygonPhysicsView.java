...
public class PolygonPhysicsView extends SurfaceView implements SurfaceHolder.Callback, PhysicsEngine.PhysicsInterface {
    ...
    public void act(double px, double py, Vector vector){
