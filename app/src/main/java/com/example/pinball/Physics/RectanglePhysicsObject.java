...
/*    public RectanglePhysicsObject(Vector2D position, double width, double height, Bitmap bitmap) {
    ...
    public RectanglePhysicsObject(Vector2D position, double width, double height, int id, Resources rsc) {
        this(position,width,height);
    ...
    public RectanglePhysicsObject(Vector2D position, double width, double height, int id, Resources rsc, boolean moveBool) {
        this(position, width, height, id, rsc);
        MovingObject = moveBool;
        if(MovingObject == false){
            InverseOfMass = 0;
            InverseOfI = 0;
    ...
    public RectanglePhysicsObject(Vector2D position, double width, double height, int id, Resources rsc, double rotation, boolean moveBool){
        this(position,width,height,id,rsc,moveBool);
        Rotation = rotation;
    }
