...
public class NetPushEngine extends Thread implements CustomThread {
    ...
    NetPushEngine(NetPhysicsView netView, Socket sock, NetInputSet netInputSet) {
        setInstanceVar(netView, sock, netInputSet);
    }

    private void setInstanceVar(NetPhysicsView netView, Socket sock, NetInputSet netInputSet) {
        NetView = netView;
        Sock = sock;
        Inputs = netInputSet;
    }
