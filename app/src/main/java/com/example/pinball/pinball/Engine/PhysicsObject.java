...
abstract public class PhysicsObject implements PhysicsObjectInterface {
    ...
    static public void outDepth_makeImpulse(com.example.pinball.Engine.PhysicsObject a, com.example.pinball.Engine.PhysicsObject b, Vector2D collisionPoint, Vector2D CollisionDirection, double collisionDepth) { //물체 A, B ,충돌점, 충돌점에서 충돌방향, 충돌깊이
        double impulse = 0;
    ...
    private static void moveOutFromDepth(com.example.pinball.Engine.PhysicsObject a, com.example.pinball.Engine.PhysicsObject b, Vector2D n, double collisionDepth) {
    ...
    public abstract void addImpulseAndFriction(double impulse, Vector2D n, Vector2D normalAngularA, double frictionForceScalar, com.example.pinball.Engine.PhysicsObject other);
    ...
    public void gameCollided(com.example.pinball.Engine.PhysicsObject other){
    ...
    abstract public boolean collisionCheck(com.example.pinball.Engine.PhysicsObject other);
