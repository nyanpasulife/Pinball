...
public class GJK {
        ...
        while (true) {
            ...
            if (simplexLast.dotProduct(SearchD) <= 0) {
                ...
                if (isSimplexContainsOrigin(Simplex)) {
                    ...
                    com.example.pinball.Engine.GJK A_p2 = new com.example.pinball.Engine.GJKNoneRecursive(APoints, onlyP2);
                    com.example.pinball.Engine.GJK B_p1 = new com.example.pinball.Engine.GJKNoneRecursive(BPoints, onlyP1);
    ...
    Vector2D findCollisionPoint(Vector2D p1, Vector2D p2){
        ...
        com.example.pinball.Engine.GJK A_p2 = new com.example.pinball.Engine.GJKNoneRecursive(APoints, ArrayP2);
        com.example.pinball.Engine.GJK B_p1 = new com.example.pinball.Engine.GJKNoneRecursive(BPoints, ArrayP1);
